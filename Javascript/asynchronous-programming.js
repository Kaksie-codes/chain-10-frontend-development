...
// setTimeout(function() {
//   console.log("Task 3: This is delayed by 2 seconds");
// }, 2000);
...
const cookNoodles = () => {
 console.log('I have decided to eat noodles');
 setTimeout(() => {
  console.log('I just bought a carton of noodles');
  setTimeout(() => {
    console.log('I just lit up the cooker');
    setTimeout(() => {
      console.log('the water is boiling');
      setTimeout(() => {
        console.log('I just added the noodles');
        setTimeout(() => {
          console.log('i just added eggs and seasonings')
          setTimeout(() => {
            console.log('My delicious pot of noodles is ready, come and join me')
          }, 5000)
        }, 2000)
      }, 2000)
    }, 5000)
